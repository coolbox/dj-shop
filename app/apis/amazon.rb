...
class Amazon < Apis::Base
  ...
  def search(artist, track)
    ...
    request_url = "https://webservices.amazon.co.uk/onca/xml?#{hash_to_url_params_string(merged_params(params))}&Signature=#{URI.escape(signature, Regexp.new("[^#{URI::PATTERN::UNRESERVED}]"))}"
